...
stock_path = 'C:\\Users\\soso6\\Documents\\GitHub\\Algorithm trading\\result\\Strong_complete_vol\\stock\\'
...
for file in tqdm(stock_file):
    ...
    if len(data.columns) in (0, 3):  # 구매신호 없는 종목은 skip
        continue
    ...
    for i, idx in enumerate(data.index):
        ...
        if val != None:
            ...
            if start_count == 5:
                break
            # for k in idx_count: #TODO 연속 시그널 발생
            #     if k == 1:
            #         start
            #     v = k
        else:
